...
import { DeviceListItem, DeviceQuery } from "@tago-io/sdk/out/modules/Account/devices.types";
 ...
 * @returns
 */
async function fetchDeviceList(account: Account, filter: DeviceQuery["filter"]): Promise<FetchDeviceResponse[]> {
